          ...
          <li class="goods__item">
            <article class="product">
              <a href="#" class="product__link">
                <img src="/src/img/goods/product01.jpg" alt="Бюстгальтер-Балконет Wien из Микрофибры"
              ...
              <div class="product__row">
                ...
                <button class="product__btn-favotite product__btn-favotite_active"
          ...
          <li class="goods__item">
            <article class="product">
              ...
              <div class="product__row">
                ...
                <button class="product__btn-favotite" aria-label="Добавить в избранное"></button>
              </div>
